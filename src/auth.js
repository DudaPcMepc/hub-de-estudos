...
import {
    ...
    criarUrlImagemPaginaCaderno,
    criarUrlPdfPaginaCaderno,
    criarMapaMental,
    ...
    enviarImagemPaginaCaderno,
    enviarPdfPaginaCaderno,
...
window.HUB_CLOUD_SUBJECT_NOTEBOOKS = Object.freeze({
    ...
    criarLote: criarNosCadernoMateria,
    criarUrlImagem: criarUrlImagemPaginaCaderno,
    criarUrlPdf: criarUrlPdfPaginaCaderno,
    ...
    enviarImagem: enviarImagemPaginaCaderno,
    enviarPdf: enviarPdfPaginaCaderno,
